...
namespace DtManager\Framework\Database\Query;
...
use DtManager\Framework\Support\Collection;
use DtManager\Framework\Pagination\Paginator;
use DtManager\Framework\Pagination\LengthAwarePaginator;
use DtManager\Framework\Support\MacroableTrait;
use DtManager\Framework\Database\Query\Grammar;
use DtManager\Framework\Database\Query\Processor;
use DtManager\Framework\Support\ArrayableInterface;
use DtManager\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \DtManager\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \DtManager\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \DtManager\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \DtManager\Framework\Database\ConnectionInterface  $connection
     * @param  \DtManager\Framework\Database\Query\Grammar  $grammar
     * @param  \DtManager\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \DtManager\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\DtManager\Framework\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \DtManager\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param  \DtManager\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \DtManager\Framework\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \DtManager\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \DtManager\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \DtManager\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \DtManager\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \DtManager\Framework\Database\Query\Grammar
     */
