...
namespace DtManager\Framework\Database\Orm\Relations;

use DtManager\Framework\Support\Arr;
use DtManager\Framework\Support\Str;
use DtManager\Framework\Database\Orm\Model;
use DtManager\Framework\Database\Orm\Builder;
use DtManager\Framework\Database\Orm\Collection;
use DtManager\Framework\Database\Orm\ModelHelperTrait;
use DtManager\Framework\Database\Orm\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Builder  $query
     * @param  \DtManager\Framework\Database\Orm\Model  $parent
     * @param  string  $table
     ...
     * @return \DtManager\Framework\Database\Orm\Relations\BelongsToMany
     */
     ...
     *
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Model|static
     *
     * @throws \DtManager\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Collection
     */
     ...
     * @param  int|null  $page
     * @return \DtManager\Framework\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  array  $columns
     * @param  string  $pageName
     * @return \DtManager\Framework\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Builder  $query
     * @param  \DtManager\Framework\Database\Orm\Builder  $parent
     * @param  array|mixed  $columns
     * @return \DtManager\Framework\Database\Orm\Builder
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Builder|null  $query
     * @return $this
     */
     ...
     *
     * @param  array   $models
     * @param  \DtManager\Framework\Database\Orm\Collection  $results
     * @param  string  $relation
     * @return array
     */
     ...
     *
     * @return \DtManager\Framework\Support\Collection
     */
     ...
     * @param  array  $joining
     * @param  bool   $touch
     * @return \DtManager\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \DtManager\Framework\Support\Collection|array  $models
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Model|\DtManager\Framework\Database\Orm\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Model|\DtManager\Framework\Database\Orm\Collection
     *
     * @throws \DtManager\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \DtManager\Framework\Support\Collection|\DtManager\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Collection|array  $ids
     * @return array
     */
     ...
     * @param  array  $attributes
     * @param  bool   $exists
     * @return \DtManager\Framework\Database\Orm\Relations\Pivot
     */
