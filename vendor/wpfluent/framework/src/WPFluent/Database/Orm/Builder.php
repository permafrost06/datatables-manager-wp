...
use DtManager\Framework\Pagination\Paginator;
use DtManager\Framework\Database\Query\Expression;
use DtManager\Framework\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \DtManager\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \DtManager\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \DtManager\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Model|\DtManager\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \DtManager\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \DtManager\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @param  string  $operator
     * @param  mixed   $value
     * @return \DtManager\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Builder  $hasQuery
     * @param  \DtManager\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \DtManager\Framework\Database\Orm\Builder|static
     ...
     *
     * @param  \DtManager\Framework\Database\Orm\Builder  $relation
     * @return \DtManager\Framework\Database\Orm\Builder|static
     */
