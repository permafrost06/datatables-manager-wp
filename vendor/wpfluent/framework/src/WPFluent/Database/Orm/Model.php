...
use DtManager\Framework\Support\Arr;
use DtManager\Framework\Support\Str;
use DtManager\Framework\Foundation\App;
use DtManager\Framework\Support\UrlRoutable;
use DtManager\Framework\Database\Orm\DateTime;
use DtManager\Framework\Foundation\Dispatcher;
use DtManager\Framework\Support\QueueableEntity;
use DtManager\Framework\Support\JsonableInterface;
use DtManager\Framework\Support\ArrayableInterface;
use DtManager\Framework\Database\Orm\Relations\Pivot;
use DtManager\Framework\Database\Orm\Relations\HasOne;
use DtManager\Framework\Database\Orm\ModelHelperTrait;
use DtManager\Framework\Database\Orm\Relations\MorphTo;
use DtManager\Framework\Database\Orm\Relations\HasMany;
use DtManager\Framework\Database\Orm\Relations\MorphOne;
use DtManager\Framework\Database\Orm\Relations\MorphMany;
use DtManager\Framework\Database\Orm\Relations\Relation;
use DtManager\Framework\Database\Orm\Relations\BelongsTo;
use DtManager\Framework\Database\Orm\Relations\MorphToMany;
use DtManager\Framework\Support\Collection as BaseCollection;
use DtManager\Framework\Database\Orm\Relations\BelongsToMany;
use DtManager\Framework\Database\Orm\Relations\HasManyThrough;
use DtManager\Framework\Database\Query\Builder as QueryBuilder;
use DtManager\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \DtManager\Framework\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @var \DtManager\Framework\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \DtManager\Framework\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \DtManager\Framework\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Eloquent\Scope|string  $scope
     * @return \DtManager\Framework\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \DtManager\Framework\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \DtManager\Framework\Database\Eloquent\Collection
     */
     ...
     *
     * @return \DtManager\Framework\Database\Eloquent\Builder
     */
     ...
     *
     * @return \DtManager\Framework\Database\Query\Builder
     */
     ...
     * @return \DtManager\Framework\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \DtManager\Framework\Database\Eloquent\Builder|static
     */
     ...
     * @return \DtManager\Framework\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \DtManager\Framework\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \DtManager\Framework\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \DtManager\Framework\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \DtManager\Framework\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \DtManager\Framework\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \DtManager\Framework\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \DtManager\Framework\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \DtManager\Framework\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \DtManager\Framework\Database\Orm\DateTime
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Query\Builder  $query
     * @return \DtManager\Framework\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param  \DtManager\Framework\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \DtManager\Framework\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'DtManager\Framework\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \DtManager\Framework\Database\Eloquent\Model
     */
     ...
     *
     * @return \DtManager\Framework\Database\Connection
     */
     ...
     *
     * @return \DtManager\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \DtManager\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \DtManager\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \DtManager\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
